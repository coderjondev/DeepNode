    ...
    <Drawer showSwipeHandle>
      <DrawerTrigger
        render={
          <Button
            className={
              "flex sm:hidden justify-end rounded-full h-10 px-4 cursor-pointer font-medium"
            }
          >
            Log in
          </Button>
      ...
      />
      <DrawerContent className="sm:max-w-sm p-0 gap-0 overflow-hidden rounded-xl text-white">
